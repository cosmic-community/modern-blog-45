...
export default function PostCard({ post }: PostCardProps) {
  ...
  return (
    <article className="bg-white rounded-xl overflow-hidden shadow-md hover:shadow-2xl transition-all duration-300 border border-blue-50 hover:border-blue-200">
      <Link href={`/posts/${post.slug}`}>
        ...
        <div className="p-6">
          ...
          <h2 className="text-xl font-bold mb-3 hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-800 hover:bg-clip-text hover:text-transparent transition-all duration-300">
            {post.title}
          </h2>
